...
const AppStore = () => {
  return (
    <>
      <div className="bg-gray-100 dark:bg-gray-600 py-14">
        <div className="container">
          <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-4">
            ...
            >
              <h1 className="text-2xl text-center sm:text-left sm:text-4xl font-semiblod dark:text-gray-400 text-gray-700 ">
                Foody us Avilable on Android and IOS
              </h1>
              <div>
                <a href="#">
                  <img
